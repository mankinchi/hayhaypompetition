...
function bootstrap() {
	...
	wp_enqueue_style('main-page-css', get_template_directory_uri() . '/css/main-page.css');
	wp_enqueue_script('main-page-js', get_template_directory_uri() . '/js/main-page.js', array('jquery'));
}
